SMART PERSON LIVE — SAME LAYOUT FIXED

This edition preserves the uploaded Clean Ghost Edition layout.

Fixes:
- GameShowAnthem.m4a is included.
- Safari/iPhone audio unlocks on the first page interaction.
- Music and Edit-panel Play Anthem buttons play/pause the same anthem.
- Restart works after audio unlock.
